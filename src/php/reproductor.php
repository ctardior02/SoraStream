...
if( isset($_POST["temporada"])) {
  $temporadaActiva = $_POST["temporada"];
  $temporadaq = filtroEpisodios($id, $temporadaActiva);
}
$id = $_GET["id"];
  ...
  <main class="container mb-4">
    ...
    <section class="ListaEpisodiosBody">
      <div class="d-flex justify-content-between">
        ...
        <select name="temporada" class="desplegableTemporada form-select">
          <?php
      ...
      <div class="ListaEpisodios">
        ...
        foreach ($episodiosq as $episodio) {
          echo " 
          <div class='Episodio d-flex w-100 justify-content-beetwen'>
